...
docker run -p 8081:8080 -v /home/ec2-user/logs:/logs -e spring.data.mongodb.uri=mongodb://mongo/thedarkcoderrises -e kafka.url=kafka:9092 --name ecart --link=mongo --link=kafka ecart:1.0
